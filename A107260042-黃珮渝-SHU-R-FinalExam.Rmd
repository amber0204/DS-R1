...
```{r}
print(Prob.Ar <- choose(4,2)*(5/8)^2*(3/8)^2)
print(Prob.Aw <- (choose(5,2)*choose(3,2))/choose(8,4))
```
...
set.seed(123456)
DrawResult <- as.data.frame(t(replicate(1000, Draw_Ball())))
sum(DrawResult$白球== 2)
